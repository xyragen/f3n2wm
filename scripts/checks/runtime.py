...
setup = """
package.path = '""" + base_fwd + """/src/?.lua;""" + base_fwd + """/src/?/init.lua;""" + base_fwd + """/src/?/?.lua;""" + base_fwd + """/layouts/?.lua;""" + base_fwd + """/?.lua;' .. package.path
_G.BASE = '""" + base_fwd + """'
...
for _, name in ipairs(names) do
    layout.arrange(name, wins, {x=0, y=0, width=1920, height=1080}, cfg)
...
local ws = Workspace:new(1, "1", {x=0,y=0,width=1920,height=1080}, 1)
ws._wm = _G.fake_wm
ws:add_window(5001)
ws:add_window(5002)
ws:add_window(5001)
...
layout.arrange("master-stack", {}, {x=0,y=0,width=1920,height=1080}, _G.cfg)
""")
...
mgr.workspaces = {}
for i = 1, 3 do
    mgr.workspaces[i] = Workspace:new(i, tostring(i), {x=0,y=0,width=1920,height=1080}, 1)
    mgr.workspaces[i]._wm = _G.fake_wm
end
mgr.current_ws = 1
